 ...
 * 企业电价配置
 */
public class PowerPriceConfigReqData implements Serializable{
	...
	private Integer voltageLevel = 0;
	// 电度电价计费方式    1分时    0普通
	private Integer chargeMode;
	// 电度电单价,0.00表示没有
	private Double basePrice = 0.00;
	// 尖电单价,0.00表示没有
	private Double apexPrice = 0.00;
	// 峰电单价,0.00表示没有
	private Double peakPrice = 0.00;
	// 平电单价,0.00表示没有
	private Double flatPrice = 0.00;
	// 谷电单价,0.00表示没有
	private Double valleyPrice = 0.00;
	// 尖时间 09:00--12:00
	private JSONArray apexTimeInterval;
	// 峰时间
	private JSONArray peakTimeInterval;
	// 平时间
	private JSONArray flatTimeInterval;
	// 谷时间
	private JSONArray valleyTimeInterval;
	// 基本电价计费方式    1变压器容量     2最大需量
	private Integer baseChargeMode;
	// 变压器容量单价
	private Double transformerCapacityPrice = 0.00;
	// 最大需量单价
	private Double maxCapacityPrice = 0.00;
	// 变压器容量/受电容量
	private Double transformerCapacity = 0.00;
	// 最大需量/核定需量
	private Double maxCapacity = 0.00;
	// 力调标准
	...
	public JSONArray getApexTimeInterval() {
		return apexTimeInterval;
	}
	public void setApexTimeInterval(JSONArray apexTimeInterval) {
		this.apexTimeInterval = apexTimeInterval;
	}
	public JSONArray getPeakTimeInterval() {
		return peakTimeInterval;
	}
	public void setPeakTimeInterval(JSONArray peakTimeInterval) {
		this.peakTimeInterval = peakTimeInterval;
	}
	public JSONArray getFlatTimeInterval() {
		return flatTimeInterval;
	}
	public void setFlatTimeInterval(JSONArray flatTimeInterval) {
		this.flatTimeInterval = flatTimeInterval;
	}
	public JSONArray getValleyTimeInterval() {
		return valleyTimeInterval;
	}
	public void setValleyTimeInterval(JSONArray valleyTimeInterval) {
