...
(function() {
    ...
    if (includeCSS) {
        document.write('<link rel="stylesheet" type="text/css" href="' + path + '/javascripts/ext/resources/css/ext-all.css"/>');
    }
    document.write('<script type="text/javascript" src="' + path + '/javascripts/ext/ext-all.js"></script>');
