...
public abstract class NetDauBiz<Q extends AbstractCommonBean, T extends NetDauResponse> {
	private static final Logger logger = LoggerFactory.getLogger(NetDauBiz.class);
