...
import stc.skymobi.bean.tlv.decode.decoders.BeanMixedTLVDecoder;
import stc.skymobi.bean.tlv.encode.encoders.BeanMixedTLVEncoder;
...
//		 AbstractApplicationContext root = new ClassPathXmlApplicationContext("classpath*:stc/protocol/mixedCodec.xml"); 
//		 tlvBeanDecoder =(BeanMixedTLVDecoder) root.getBean("tlvBeanDecoder"); 
//		 tlvBeanEncoder = (BeanMixedTLVEncoder) root.getBean("tlvBeanEncoder");
	...
	public void test() throws IOException {
		...
		File file = new File("D:\\test\\long.jpg");
