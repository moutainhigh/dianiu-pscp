...
public class Logout extends AbstractLocalTest {
	...
	private byte[] msgcode = ByteUtil.int2bytes(1002004);
	...
	public void test() throws IOException {
		...
		LogoutResponse resp = JSONObject
				.parseObject(result, LogoutResponse.class);
