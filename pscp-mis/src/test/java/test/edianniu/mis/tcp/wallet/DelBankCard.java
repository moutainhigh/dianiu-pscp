...
public class DelBankCard extends AbstractLocalTest {
	private static final Logger log = LoggerFactory.getLogger(DelBankCard.class);
	...
	private byte[] msgcode = ByteUtil.int2bytes(1002034);
	...
	public void test() throws IOException {
		...
		DelBankCardResponse resp = JSONObject.parseObject(result, DelBankCardResponse.class);
