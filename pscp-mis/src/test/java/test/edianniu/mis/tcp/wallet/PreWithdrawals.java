...
public class PreWithdrawals extends AbstractLocalTest {
	private static final Logger log = LoggerFactory.getLogger(PreWithdrawals.class);
	...
	private byte[] msgcode = ByteUtil.int2bytes(1002031);
	...
	public void test() throws IOException {
		...
		PreWithdrawalsRequest request = new PreWithdrawalsRequest();
		...
		PreWithdrawalsResponse resp = JSONObject.parseObject(result, PreWithdrawalsResponse.class);
