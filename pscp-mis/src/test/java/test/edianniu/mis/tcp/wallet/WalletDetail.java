...
public class WalletDetail extends AbstractLocalTest {
	private static final Logger log = LoggerFactory.getLogger(WalletDetail.class);
	...
	private byte[] msgcode = ByteUtil.int2bytes(1002030);
	...
	public void test() throws IOException {
		...
		WalletDetailRequest request = new WalletDetailRequest();
		...
		WalletDetailResponse resp = JSONObject.parseObject(result, WalletDetailResponse.class);
