...
public class Test {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("功率因数:"+factor);
	    Date startTime=DateUtils.parse("20180312033000", "yyyyMMddHHmmss");
	    Date endTime=DateUtils.parse("20180312041500", "yyyyMMddHHmmss");
	    System.out.println("xxx:"+Math.random()+","+endTime.getTime());
	   
		for(int i=0;i<1000;i++){
			 Double nocharge = Math.random()/5;
				Double charge = nocharge+Math.random()/5;
				 System.out.println("nocharge:"+nocharge+",charge:"+charge);	
		}
		/*String nowTime="";
