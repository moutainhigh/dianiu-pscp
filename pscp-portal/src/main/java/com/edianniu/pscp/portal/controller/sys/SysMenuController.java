...
import com.edianniu.pscp.portal.utils.RRException;
...
public class SysMenuController extends AbstractController {
	...
	public R perms(){
		//查询列表数据
		List<SysMenuEntity> menuList = sysMenuService.queryMenusByCompanyId(this.getUser().getCompanyId());
