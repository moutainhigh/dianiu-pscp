...
public class BizUtils {
	...
	/*public static void main(String[] args) {
		String teString  =  "05:22:12";
		String ssString = "09:09:16";
		boolean flag = cheackTimePattern(teString);
		boolean flag1 = cheackTimePattern(ssString);
		boolean a = !(flag && flag1);
		
		System.out.println(a);
		
		System.out.println("isPositiveNumber:" + isPositiveNumber("-1231232"));
