...
public class BizUtils {
    ...
    public static void main(String[] args) throws ParseException {
    	String a = "0.00";
    	boolean positiveNumber = BizUtils.isPositiveNumber(a);
     ...
     * @return
     */
    public static String stringAddString(String num1, String num2){
    	String result = "0.00";
    	if (!(BizUtils.isNumber(num1)&&BizUtils.isNumber(num2))) {
    		return result;
		}
    	result = BizUtils.doubleToString(Double.valueOf(num1) + Double.valueOf(num2));
    	return result;
    }
