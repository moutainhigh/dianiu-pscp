 ...
 *
 */
package test.edianniu.renter.mis.tcp;
...
import test.edianniu.renter.mis.tcp.until.ByteUtil;
import test.edianniu.renter.mis.tcp.until.HeadUtil;
...
public abstract class AbstractLocalTest {
    ...
    protected static int Port = 20009; // 未加密
