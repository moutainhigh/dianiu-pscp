...
/**
 * DayVoltageCurrentDetailRepository
 * @author yanlin.chen 
 ...
 */
@Repository
public class DayVoltageCurrentDetailRepository {
     ...
     * @return
     */
    public SearchResponse queryList(DayVoltageCurrentDetailQuery listQuery) {
        // 依据查询索引库名称创建查询索引
        SearchRequestBuilder searchRequestBuilder = this.client.prepareSearch(Constants.METER_INDEX);
        //设置查询文档,表名
        searchRequestBuilder.setTypes(Constants.METER_DAY_VOLTAGE_CURRENT_DETAIL_TYPE);
        //设置查询类型
     ...
     * @return
     */
    private BoolQueryBuilder getQueryBuilder(DayVoltageCurrentDetailQuery listQuery) {
    ...
    public IndexResponse save(String id, Map<String, Object> param) throws Exception {
        ...
        return this.client.prepareIndex(Constants.METER_INDEX, Constants.METER_DAY_VOLTAGE_CURRENT_DETAIL_TYPE, id).setSource(builder).get();
    }
    ...
    public UpdateResponse updateById(String id, Map<String, Object> param) throws Exception {
        UpdateRequest updateRequest = new UpdateRequest(Constants.METER_INDEX, Constants.METER_DAY_VOLTAGE_CURRENT_DETAIL_TYPE, id);
    ...
    public GetResponse getById(String id) {
        return this.client.prepareGet(Constants.METER_INDEX, Constants.METER_DAY_VOLTAGE_CURRENT_DETAIL_TYPE, id).get();
    }
    /**
     * 根据主键删除
     *
    ...
    public DeleteResponse deleteById(String id) {
        return this.client.prepareDelete(Constants.METER_INDEX, Constants.METER_DAY_VOLTAGE_CURRENT_DETAIL_TYPE, id).get();
    }
}
