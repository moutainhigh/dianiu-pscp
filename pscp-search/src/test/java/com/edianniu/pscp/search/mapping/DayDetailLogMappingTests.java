...
public class DayDetailLogMappingTests {
	ApplicationContext ctx = new ClassPathXmlApplicationContext(
			"classpath*:test.xml");
	@Test
	public void rebuildIndex() throws Exception{
		ElasticssearchConfig elasticssearchConfig=(ElasticssearchConfig) ctx.getBean("elasticssearchConfig");
		//elasticssearchConfig.getClient().admin().indices().prepareDelete(Constants.METER_INDEX).execute().actionGet(); 
		//elasticssearchConfig.getClient().admin().indices().prepareCreate(Constants.METER_INDEX).execute().actionGet(); 
		createMapping();
	...
	public void createMapping() throws Exception{
		...
		builder.setType(Constants.METER_DAY_DETAIL_LOG_TYPE);  
	...
	private  XContentBuilder getMapping() throws Exception{  
        XContentBuilder mapping = jsonBuilder()    
                   .startObject()    
                     .startObject(Constants.METER_DAY_DETAIL_LOG_TYPE)    
