...
public class ReportDayLoadDetailMappingTests {
	...
	public void rebuildIndex() throws Exception{
		...
		createReportDayAggregateMapping();
		
	}
	//@Test
	public void createReportDayAggregateMapping() throws Exception{
		ElasticssearchConfig elasticssearchConfig=(ElasticssearchConfig) ctx.getBean("elasticssearchConfig");
		...
		builder.setType(Constants.METER_DAY_LOAD_DETAIL_TYPE);  
	...
	private  XContentBuilder getMapping() throws Exception{  
        XContentBuilder mapping = jsonBuilder()    
                   .startObject()    
                     .startObject(Constants.METER_DAY_LOAD_DETAIL_TYPE)    
