...
/**
 * ClassName: MemberWalletDetail
 * Author: tandingbo
 * CreateTime: 2017-06-30 15:56
 */
public class MemberWalletDetail extends BaseDo implements Serializable {
    ...
    public int getFundTarget() {
        return fundTarget;
    }

    public void setFundTarget(int fundTarget) {
