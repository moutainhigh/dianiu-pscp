 ...
 * @version V1.0
 */
public class NetDauDeviceResponse implements Serializable  {
	
	private static final long serialVersionUID = 1L;
	private CommonDo common;
	private DeviceAckDo device;
	...
	public DeviceAckDo getDevice() {
		return device;
	}

	public void setDevice(DeviceAckDo device) {
		this.device = device;
	}
